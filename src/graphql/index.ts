...
async function startApolloServer() { 
  ...
  app.use(cookieParser());
	...
	const server = new ApolloServer({
		typeDefs: [accountTypeDefs, productTypeDefs, adminTypeDefs, commentTypeDefs, blogTypeDefs, bookingTypeDefs, contactTypeDefs, userTypeDefs],
		resolvers: [accountResolvers, productResolvers, adminResolvers, commentResolvers, blogResolvers, bookingResolver, contactResolver, userResolvers],
		context: ({ req, res }) => {
